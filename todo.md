...
## Jarvis Protocol Login Page
- [x] Build branded /login page with "Jarvis Protocol" theme (cosmic NLF styling)
- [x] Show benefits of signing up (faster checkout, exclusive drops, collection tracking)
- [x] Frame OAuth as "Secure Sign-In Partner" — no Manus branding visible
- [x] "Initialize Jarvis Protocol" button redirects to OAuth
