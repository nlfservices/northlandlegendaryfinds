/**
 * Giveaway Landing Page â€” Redesigned for Maximum Hype
 * Hero with treasure chest â†’ What We Give Away â†’ Live Show Experience â†’ $15 Credit â†’ Stats â†’ Cards â†’ Legal
  ...
  return (
    <>
      <div className="min-h-screen pb-20 md:pb-0">
        <SEO
          title="Free Marvel Card Giveaways + $15 Credit â€” Whatnot Live Shows"
        ...
        <section className="py-14 sm:py-20 lg:py-24 border-t border-border/20">
          <div className="container">
            ...
            {/* CTA after How It Works â€” SECTION 4: Purple invite + Green shows */}
