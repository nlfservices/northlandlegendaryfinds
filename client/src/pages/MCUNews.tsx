    ...
    <div className="min-h-screen">
      ...
      <section className="relative min-h-[400px] lg:min-h-[500px] flex items-center overflow-hidden">
        <div className="absolute inset-0">
          <SafeImage src={HERO_IMG} fallbackSrc={HULK_PLACEHOLDER} alt="" className="w-full h-full object-cover" />
            ...
            <aside className="w-full lg:w-80 flex-shrink-0 space-y-6">
              ...
              <div className="bg-card rounded-xl border border-border overflow-hidden">
                <div className="aspect-[16/9] overflow-hidden">
                  <SafeImage src={CARD_MARKET_IMG} fallbackSrc={HULK_PLACEHOLDER} alt="Card Market" className="w-full h-full object-cover" />
                </div>
                <div className="p-5">
