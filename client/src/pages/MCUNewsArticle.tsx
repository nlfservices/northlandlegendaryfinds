...
const WHO_WOULD_WIN_THEMES: Record<string, { accent: string; accentBg: string; accentBorder: string; gradient: string; headingColor: string }> = {
  "who-would-win-wolverine-vs-captain-america": { accent: "text-yellow-400", accentBg: "bg-yellow-500/10", accentBorder: "border-yellow-500/30", gradient: "from-yellow-500/20 via-blue-600/10 to-red-500/20", headingColor: "text-yellow-400" },
  "who-would-win-storm-vs-thor": { accent: "text-sky-300", accentBg: "bg-sky-500/10", accentBorder: "border-sky-500/30", gradient: "from-white/10 via-sky-500/20 to-blue-600/10", headingColor: "text-sky-300" },
  "who-would-win-magneto-vs-iron-man": { accent: "text-red-400", accentBg: "bg-red-500/10", accentBorder: "border-red-500/30", gradient: "from-red-500/20 via-gray-400/10 to-red-700/20", headingColor: "text-red-400" },
  "who-would-win-phoenix-vs-scarlet-witch": { accent: "text-orange-400", accentBg: "bg-orange-500/10", accentBorder: "border-orange-500/30", gradient: "from-orange-500/20 via-red-500/10 to-purple-500/20", headingColor: "text-orange-400" },
  "who-would-win-hulk-vs-colossus": { accent: "text-green-400", accentBg: "bg-green-500/10", accentBorder: "border-green-500/30", gradient: "from-green-500/20 via-green-700/10 to-gray-400/10", headingColor: "text-green-400" },
  "who-would-win-cyclops-vs-captain-america": { accent: "text-blue-400", accentBg: "bg-blue-500/10", accentBorder: "border-blue-500/30", gradient: "from-blue-500/20 via-yellow-500/10 to-red-500/10", headingColor: "text-blue-400" },
  "who-would-win-deadpool-vs-spider-man": { accent: "text-red-500", accentBg: "bg-red-500/10", accentBorder: "border-red-500/30", gradient: "from-red-600/20 via-red-500/10 to-blue-500/10", headingColor: "text-red-500" },
  "who-would-win-doctor-doom-vs-magneto": { accent: "text-emerald-400", accentBg: "bg-emerald-500/10", accentBorder: "border-emerald-500/30", gradient: "from-emerald-500/20 via-gray-500/10 to-purple-500/20", headingColor: "text-emerald-400" },
  "who-would-win-black-panther-vs-wolverine": { accent: "text-purple-400", accentBg: "bg-purple-500/10", accentBorder: "border-purple-500/30", gradient: "from-purple-500/20 via-black/10 to-yellow-500/10", headingColor: "text-purple-400" },
  "who-would-win-thor-vs-hulk-rematch": { accent: "text-blue-400", accentBg: "bg-blue-500/10", accentBorder: "border-blue-500/30", gradient: "from-blue-500/20 via-yellow-500/10 to-green-500/20", headingColor: "text-blue-400" },
};
...
function ArticleContentWithBanner({ content }: { content: string }) {
  const { firstHalf, secondHalf } = useMemo(() => {
    ...
    if (splitIndex === -1) splitIndex = Math.floor(lines.length * 0.35);
    return {
      ...
      <article className={getArticleTemplate(article.templateLayout as ArticleTemplate | null, article.id) === "patriotic" ? "py-0" : "container max-w-4xl py-8 lg:py-12"}>
        ...
        {article.featuredImageUrl && getArticleTemplate(article.templateLayout as ArticleTemplate | null, article.id) === "classic" && (
          <SafeImage
            ...
            alt={article.title}
            wrapperClassName="rounded-xl overflow-hidden mb-8 border border-border"
