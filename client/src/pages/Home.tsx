    ...
    <div className="min-h-screen">
      ...
      <section className="relative py-16 lg:py-20 overflow-hidden">
        ...
        <div className="container relative z-10 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-orange-500/15 border border-orange-500/30 rounded-full mb-6">
            <span className="text-orange-400 text-sm font-bold tracking-wide">400+ SHOWS LISTED</span>
          </div>
          <h2 className="text-4xl sm:text-5xl font-bold mb-4" style={{ fontFamily: "'Anton', sans-serif" }}>
            FIND A <span className="text-primary">CARD SHOW</span> NEAR YOU
          </h2>
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto mb-8">
            Browse our comprehensive directory of sports card shows, trading card expos, and collectibles conventions across all 50 states. Find your next show today.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/submit-show">
              <Button size="lg" variant="outline" className="border-orange-500/40 text-orange-400 hover:bg-orange-500/10 font-bold text-lg px-10 py-6">
                Submit Your Show
              </Button>
            </Link>
          </div>
