 ...
 * Usage: node generate_collector_batch.mjs <batch_number>
...
// Characters needing new portrait images
const CHARACTERS = [
  // Batch 1
  ...
  { name: 'The High Evolutionary', prompt: 'Stylized digital portrait of a man in a sleek red and silver armored suit with a distinctive helmet, menacing expression, inspired by MCU Guardians Vol 3 villain, dramatic lighting, Marvel art style, laboratory background' },
